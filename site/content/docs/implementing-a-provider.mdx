---
title: "Implementing a CGP provider"
description: "How to implement a CGP provider in-process with Rust or over the language-neutral stdio and HTTP wire protocol."
---
...
[**conformance registry**](./registry) — a table of conformant providers with
a reproducible report backing each claim, plus the
...
self-attested form: see [registry.md](./registry#how-to-get-listed) for
