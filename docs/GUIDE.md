...
| [0009](./adr/0009-adopt-standing-decisions-scr-corpus.md) | Standing decisions as a Steering Context Record corpus | Superseded by oxagen ADR-137. The directives are workspace context records in oxagen `.oxagen/rules/`. This repository does not keep a `docs/scr/` copy. |
