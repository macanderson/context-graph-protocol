...
block() {
  echo "Blocked (SCR-001): full test-suite builds are CI's job. Scope it: $1 — see https://github.com/macanderson/oxagen/blob/main/.oxagen/rules/ctx.scr.001-no-full-suite-builds.toml" >&2
  exit 2
}
